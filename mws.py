...
class Products(MWS):
    ...
    def get_lowest_priced_offers_for_sku(self, marketplaceid, sku, condition="Any", excludeme="False"):
    ...
    def get_lowest_priced_offers_for_asin(self, marketplaceid, asin, condition="Any", excludeme="False"):
